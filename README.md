...
I am a software engineer focused on applied AI, backend services, and automation. My work sits where models meet real product workflows: assistants that can act, RAG systems that retrieve the right context, APIs that are easy to integrate, and tools that remove repetitive work.

```txt
problem -> prototype -> evaluate -> harden -> ship -> improve
```
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Local-first AI assistant for task execution, file operations, and development workflows.</p>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" alt="Python" />
        <img src="https://img.shields.io/badge/Agents-111827?style=flat-square" alt="Agents" />
        <img src="https://img.shields.io/badge/Automation-0F766E?style=flat-square" alt="Automation" />
      </p>
    </td>
    <td width="50%" valign="top">
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:14B8A6,55:2563EB,100:020617&height=95&section=footer" alt="Footer wave" />
</p>
