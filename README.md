<picture>
  ...
  <img src="assets/header-light.svg" alt="Fayez Bast — software engineer" width="100%">
</picture>
...
<sub>[**email**](mailto:fayezbast15@gmail.com) · [**linkedin**](https://linkedin.com/in/fayez-bast) · [**repositories**](https://github.com/FayezBast?tab=repositories)</sub>
...
<sub>prototype → evaluate → harden → ship</sub>
